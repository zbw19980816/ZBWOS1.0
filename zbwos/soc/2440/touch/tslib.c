/*
    touch screen -> LCD 坐标数据转化
*/

/* touch screen固件测试参数 */
static double g_kx = 0.542857;
static double g_ky = 0.387824;

static int g_ts_xc = 517, g_ts_yc = 522;
static int g_lcd_xc = 240, g_lcd_yc = 136;

static int g_ts_xy_swap = 1;
...
void ts_calibrate(void) {
    ...
    #if 0
    printf("lcd_s[%d], ts_s1[%d], ts_s2[%d], lcd_d[%d], ts_d1[%d], ts_d2[%d], e_ts_x[%d], e_ts_y[%d]\n\r", lcd_s, ts_s1, ts_s2, lcd_d, ts_d1, ts_d2, e_ts_x, e_ts_y);

    lcd_s[380], ts_s1[705], ts_s2[708], lcd_d[172], ts_d1[447], ts_d2[440], e_ts_x[517], e_ts_y[522]
    A lcd_x =       50, lcd_y =       47
    B lcd_x =      429, lcd_y =       52
    C lcd_x =      427, lcd_y =      223
    D lcd_x =       46, lcd_y =      221
    E lcd_x =      240, lcd_y =      136
